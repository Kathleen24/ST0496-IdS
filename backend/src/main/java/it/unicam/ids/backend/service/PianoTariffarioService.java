...
public class PianoTariffarioService {
    ...
    public PianoTariffario addPianoTariffario(Integer id, Double costo, Boolean newsLetterService,
                                              Boolean emailService, Boolean calendarService, Boolean smsService){
        return pianoTariffarioRepository.save(new PianoTariffario(id, costo, newsLetterService, emailService,
                calendarService, smsService));
    }
    ...
    public void updatePianoTariffario(Integer id, Double costo, Boolean newsLetterService,
                                      Boolean emailService, Boolean calendarService, Boolean smsService){
        pianoTariffarioRepository.save(new PianoTariffario(id, costo, newsLetterService, emailService,
                calendarService, smsService));
    }
